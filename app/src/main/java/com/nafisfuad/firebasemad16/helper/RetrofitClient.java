...
public class RetrofitClient {
    ...
    public static Retrofit getClientForNearbyPlaces() {
        return new Retrofit.Builder().baseUrl(NEARBY_BASE_URL).addConverterFactory(GsonConverterFactory.create()).build();
    }
}
